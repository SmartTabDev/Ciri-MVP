...
const ScaleSlider: React.FC<ScaleSliderProps> = ({
  ...
  return (
    <div className="mx-auto mt-8 w-full max-w-md">
      <div className="relative flex h-12 items-center gap-3 rounded-full bg-black pr-6 pl-4 dark:bg-white">
        {/* Value Indicator */}
        <div className="relative flex h-6 w-12 items-center justify-center text-sm font-semibold whitespace-nowrap text-white dark:text-black">
          <AnimatedValue
            value={currentValue}
            progress={progress}
            minValue={minValue}
        ...
        <div className="relative h-1/3 w-full">
          ...
          >
            {/* Thumb */}
            <motion.div className="absolute top-1/2 right-0 h-6 w-6 translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-neutral-800 bg-white shadow-md dark:border-neutral-300 dark:bg-black" />
          </motion.div>
