    ...
    <div className="flex flex-col items-center gap-6 mt-8 w-full max-w-sm">
      ...
      <div className="flex flex-col items-center gap-6 w-full">
        <p className="text-sm text-center">
          Click the button below to securely connect your Outlook account. You&apos;ll be redirected to Microsoft to authorize the connection.
        </p>
        <Button
          type="button"
          className="w-full text-base font-semibold bg-white text-[#0078d4] border border-[#0078d4] hover:bg-[#f0f8ff] hover:text-[#005a9e] p-2 shadow-md max-w-32"
          style={{ boxShadow: '0 2px 8px 0 rgba(0,120,212,0.10)', height: 'max-content' }}
          onClick={handleOutlookConnect}
        >
          <OutlookIcon style={{width: 100, height: 100}} />
        </Button>
      </div>
    </div>
  );
