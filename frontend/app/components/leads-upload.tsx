...
//This uploader is fetched from https://originui.com/file-upload
      ...
      >
        ...
        {files.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center px-4 py-3 text-center">
            ...
            <p className="mb-1.5 text-sm font-medium">Slipp filene dine her</p>
            <p className="text-muted-foreground flex flex-col gap-2 text-xs">
              Maksimum {maxFiles} filer ∙ Opptil {maxSizeMB}MB{" "}
              <span>Kun Excel/CSV format</span>
            </p>
